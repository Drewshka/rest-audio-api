...
// exports.getAudioFile = (req, res, next) => {
//   const audioFile = Audio.getOneById(req.params.id);
//   if (!audioFile) {
//     const err = new Error("Please provide a valid ID.");
//     err.status = 400;
//     next(err);
...
// exports.editAudioFile = (req, res, next) => {
//   console.log("req.body", req.body);
//   if (!req.body.title && !req.body.artist && !req.body.audioSrc) {
//     const err = new Error(
//       "PUT request requires title, artist and audio source"
...
//     next(err);
//   } else {
//     const updatedArray = Audio.update(req.params.id, req.body);
//     if (!updatedArray) {
//       const err = new Error("Please provide a valid id.");
//       err.status = 400;
//       next(err);
